 ...
 *
 * @see       http://wiki.joostina-cms.ru/index.php/JLText
 */
class JLText {
	...
	public function outlink_parse($text) {
		...
		$host = str_replace(array('http://', 'www.'), '', _JLPATH_SITE);
		...
		return preg_replace('/href="?(http:\/\/(?!(www\.|)' . $host . ')([^">\s]*))/ie', "'href=\"" . _JLPATH_SITE . "/out.php?url=' . urlencode('\$1') . '\"'", $text);
	}
