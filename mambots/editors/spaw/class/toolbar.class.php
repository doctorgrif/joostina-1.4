...
class SpawToolbar
{
     ...
     * @static
     */
    public static function getToolbar($name)
    {
                ...
                if (is_object($obj) && ($obj->agent & SpawAgent::getAgent())) {
                    ...
                    switch (strtolower(get_class($obj))) {
                        ...
                        case "spawtbbutton":
                        {
                            ...
                            $js_res .= $prefix . '_obj.addToolbarItem(new SpawTbButton("' . $obj->module . '","' . $obj->name . '","' . $id . '","' . $obj->on_enabled_check . '","' . $obj->on_pushed_check . '","'
                                . $obj->on_click . '","' . $pgdir . $img_src . '",' . ($obj->show_in_context_menu ? "true" : "false") . '),"' . $this->name . '");';
                        ...
                        case "spawtbdropdown":
                        {
                            ...
                            if (is_array($obj->data)) {
                                $js_res .= $prefix . '_obj.addToolbarItem(new SpawTbDropdown("' . $obj->module . '","' . $obj->name . '","' . $id . '","' . $obj->on_enabled_check . '","' . $obj->on_status_check . '","'
                                    . $obj->on_change . '"),"' . $this->name . '");';
