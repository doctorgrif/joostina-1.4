(function (a) {
    elFinder = function (d, g) {
        ...
        function e() {
            c(null, b.dialog.height() - b.view.tlb.parent().height() - (32))
        }
    ...
    elFinder.prototype.ui.prototype.commands = {back:function (c) {
        ...
        this.exec = function () {
            ...
            o.append(k.append(l.hide()).prepend(h).append(s)).dialog({dialogClass:"el-finder-dialog", title:b.fm.i18n("Upload files"), modal:true, resizable:false, close:function () {
                ...
                // Отключено из-за не совместимости с jQuery 2.0
                // 16.08.2013
    ...
    elFinder.prototype.quickLook.prototype.plugins = {image:new function () {
        ...
        this.show = function (e, d) {
            ...
            if (e.mimes[d.mime] && d.hash == e._hash) {
                a("<img/>").hide().appendTo(e.media.show()).attr("src", d.url + ("")).load(function () {
...
(function (a) {
    elFinder.prototype.eventsManager = function (d, c) {
        ...
        this.init = function () {
            ...
            a("input,textarea").on("focus",function (i) {
                g.lock = true
            }).on("blur", function (i) {
                g.lock = false
            });
            ...
            a(document).bind("keydown", function (i) {
                if (g.lock) {
                    return
                }
                switch (i.keyCode) {
