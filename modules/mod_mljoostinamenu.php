...
<?php
    ...
    function mosGetJoostinaLink($mitem, $level = 0, $params, $open = null)
    {
        ...
        if (JSef::$url == JSef::getUrlToSef($mitem->link)) {
        ...
        if ($params->get('ml_imaged') == 1) {
            ...
            $mitem->name
                = '<img src="' . _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/zaglushka.gif" border="0" alt="'
                . $ml_alt . '" />';
            ...
            $ml_alt = $mitem->name;
            $ml_img_title = ' title="' . $pg_title . '"';
            $mitem->name = '<em>' . $mitem->name . '</em><img src="' . _JLPATH_SITE
    ...
    function mosShowVIMenuMLZ(&$params)
    {
        ...
        $and = '';
        if (!JCore::getCfg('shownoauth') AND !JCore::getCfg('disable_access_control')) {
    ...
    function mosJoostinaShowLink($params, $style = 0)
    {
        ...
        <script type="text/javascript">
            ...
            offImgArray["ml_img_1_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image1; ?>";
            offImgArray["ml_img_2_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image2; ?>";
            offImgArray["ml_img_3_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image3; ?>";
            offImgArray["ml_img_4_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image4; ?>";
            offImgArray["ml_img_5_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image5; ?>";
            offImgArray["ml_img_6_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image6; ?>";
            offImgArray["ml_img_7_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image7; ?>";
            offImgArray["ml_img_8_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image8; ?>";
            offImgArray["ml_img_9_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image9; ?>";
            offImgArray["ml_img_10_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image10; ?>";
            offImgArray["ml_img_11_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image11; ?>";
            ...
            onImgArray["ml_img_1_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_1; ?>";
            onImgArray["ml_img_2_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_2; ?>";
            onImgArray["ml_img_3_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_3; ?>";
            onImgArray["ml_img_4_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_4; ?>";
            onImgArray["ml_img_5_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_5; ?>";
            onImgArray["ml_img_6_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_6; ?>";
            onImgArray["ml_img_7_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_7; ?>";
            onImgArray["ml_img_8_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_8; ?>";
            onImgArray["ml_img_9_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_9; ?>";
            onImgArray["ml_img_10_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_10; ?>";
            onImgArray["ml_img_11_<?php echo $ml_module_number; ?>"].src = "<?php echo
                _JLPATH_SITE . '/modules/mod_mljoostinamenu/menuimages/' . $ml_image_roll_11; ?>";
        </script>
        <?php
        }
        switch ($style) {
