...
DEFINE('_ENABLE_UNPUBLISHED_MAMBOTS_HELP', 'Некоторые мамботы работают даже в неопубликованном состоянии, и очищают текст от спецтегов типа {* *}. Если у вас их нет - рекомендуется выбрать НЕТ.');
