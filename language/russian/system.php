 ...
 */
DEFINE('_DATE_FORMAT_LC', JCore::getCfg('form_date')); //Используйте формат PHP-функции strftime
DEFINE('_DATE_FORMAT_LC2', JCore::getCfg('form_date_full')); // Полный формат времени
...
/*
 * Языковые константы GDDatabase index.php
 * @doctorgrif (30.10.13 08:47): языковые переменные вынесены в языковой файл
 */
...
DEFINE('_MAIL_MSG', 'Здравствуйте $adminName,\n\nПользователь $author предлагает новый материал в раздел $type с названием $title' .
	' для сайта _JLPATH_SITE.\n\n\n' .
	'Пожалуйста, зайдите в панель администратора по адресу _JLPATH_SITE/administrator для просмотра и добавления его в $type.\n\n' .
