...
DEFINE('_NEWPASS_MSG', 'Учетная запись пользователя $checkusername соответствует адресу e-mail.\n' .
	' Пользователь сайта _JLPATH_SITE сделал запрос на получение нового пароля.\n\n' .
...
DEFINE('_USEND_MSG_NOPASS', 'Здравствуйте $name,\n\nВы успешно зарегистрированы на сайте '._JLPATH_SITE.'.\n' .
	'Вы можете зайти на сайт '._JLPATH_SITE.', используя данные, которые Вы указали при регистрации.\n\n' .
