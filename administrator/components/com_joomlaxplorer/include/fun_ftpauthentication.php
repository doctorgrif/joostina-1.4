...
function ftp_authentication($ftp_login = '', $ftp_pass = ''){
	...
	<form name="ftp_auth_form" method="post" action="<?php echo _JLPATH_SITE ?>/<?php echo JADMIN_BASE?>/index3.php" onsubmit="return checkFTPAuth('<?php echo _JLPATH_SITE ?>/<?php echo JADMIN_BASE?>/index3.php');" id="adminform">
		...
		<table class="adminform" style="width:400px;">
			<tr>
				<th colspan="3"><?php echo $GLOBALS["messages"]["ftp_login_lbl"] ?></th>
			</tr>

			<tr>
				<td colspan="3" style="text-align:center;" id="loadingindicator"></td>
			</tr>
			<tr>
				<td colspan="3" style="font-weight:bold;text-align:center" id="statustext">&nbsp;</td>
			</tr>
