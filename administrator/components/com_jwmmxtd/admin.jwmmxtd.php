...
<div id="jwmmxtd">
	<form action="index2.php" name="adminForm" method="POST" enctype="multipart/form-data">
		...
		<table style="width:100%;" cellpadding="0" cellspacing="0">
			<tr>
				<td><?php echo _JWMM_IMAGE_LINK ?></td>
				<td><input onfocus="this.select()" type="text" id="file_link" name="file_link" class="inputbox" size="100"/></td>
			...
			<tr>
				<td><?php echo _JWMM_IMAGE_HREF ?></td>
				<td><input onfocus="this.select()" type="text" id="file_href" name="file_href" class="inputbox" size="100"/></td>
			</tr>
			<tr>
				<td><?php echo _JWMM_IMAGE_TAG ?></td>
				<td><input onfocus="this.select()" type="text" id="file_url" name="file_url" class="inputbox" size="100"/></td>
			</tr>
		</table>
		<div id="actions">
...
<table class="adminheading">
	<tr>
		<th class="media"><?php echo _JWMM_EDIT_IMAGE?></th>
	</tr>
</table>
<div id="mymsg"></div>
...
<fieldset>
	<legend><?php echo _HEIGHT?> x <?php echo _WIDTH?></legend>
