...
class XmapAdminHtml{
		...
		<div id="sitemap<?php echo $sitemap->id; ?>" class="sitemap">
			<div class="sitemaptop">
				<div class="tl">
					<div class="tr">
						<div class="tm">
							<div class="smname" id="sitemapname<?php echo $sitemap->id; ?>" onClick="editTextField(this,<?php echo $sitemap->id; ?>,'name');"><?php echo $sitemap->name; ?></div>
							<div class="divimgdefault"><?php echo '<img src="', $xmapComponentURL, '/images/', ($default ? 'default.gif' : 'no_default.gif'), '" id="imgdefault', $sitemap->id, '" />'; ?></div>
							<div class="optionsbut" id="optionsbut<?php echo $sitemap->id; ?>" onClick="optionsMenu(<?php echo $sitemap->id; ?>);"><span><?php echo _SETTINGS;?></span></div>
						</div>
					</div>
				</div>
			</div>
			<div class="mr">
				<div class="mm">
					<div class="menulistouter">
						...
						<div class="add_menu_link" onClick="showMenusList(<?php echo $sitemap->id ?>,this);"/>
						<span class="plussign">+</span><?php echo _SAVE_MENU; ?></div>
				</div>
				<div class="sitemapinfo">
					<div><?php echo _XMAP_SITEMAP_ID . ': ' . $sitemap->id; ?></div>
					<div>
						<table cellspacing="2" cellpadding="2" class="sitemapstats">
							<tr>
								<td>&nbsp;</td>
								<td>HTML</td>
								<td>XML</td>
	...
	<table class="adminform">
		<tr>
			<th><?php echo sprintf(_XMAP_TIT_SETTINGS_OF, $sitemap->name); ?>
				<div class="settingstoptool"></div>
			</th>
		</tr>
	</table>
	...
	public static function showMenuOptions($sitemap, $menu, $lists){
		...
		<form name="frmMenuOptions" id="frmMenuOptions">
			...
			<table class="adminform">
				<tr>
					<th><?php echo sprintf(_XMAP_TIT_SETTINGS_OF, $menu->menutype); ?>
						<div class="settingstoptool"></div>
					</th>
				</tr>
			</table>
	...
	<table class="adminform">
		<tr>
			<th><?php echo _XMAP_PLUGIN_SET . $extension->extension;?></th>
		</tr>
	</table>
