...
class BossImagePlugin
{
    ...
    function getListDisplay($directory, $content, $field, $field_values, $conf)
    {
        ...
        while (!$ok) {
            if ($i <= $field_values['nb_images']) {
                ...
                if (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.jpg")) {
                    $pic = _JLPATH_SITE . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.jpg";
                } elseif (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.png")) {
                    $pic = _JLPATH_SITE . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.png";
                } elseif (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.gif")) {
                    $pic = _JLPATH_SITE . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.gif";
                } else {
                    $pic = null;
                }
                if (!is_null($pic)) {
                    $return .= "<img src='" . $pic . "' alt='" . htmlspecialchars(stripslashes(cutLongWord($content->name)), ENT_QUOTES) . "' />";
                    $ok = 1;
                }
            } else {
                if ((BOSS_NOPIC != "") && (file_exists(_JLPATH_ROOT . "/templates/com_boss/" . $conf->template . "/images/" . BOSS_NOPIC))) {
                    $return .= "<img src='" . _JLPATH_SITE . "/templates/com_boss/" . $conf->template . "/images/" . BOSS_NOPIC . "' alt='nopic' />";
                } else {
                    $return .= "<img src='" . _JLPATH_SITE . "/templates/com_boss/" . $conf->template . "/images/nopic.gif' alt='nopic' />";
                }
                $ok = 1;
            }
            $i++;
    ...
    function getDetailsDisplay($directory, $content, $field, $field_values, $conf)
    {
        ...
        for ($i = 1; $i < $nb + 1; $i++) {
            ...
            if (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.jpg")) {
                $pic = _JLPATH_SITE . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.jpg";
                $piclink = _JLPATH_SITE . "/images/boss/$directory/contents/" . $content->id . $ext_name . ".jpg";
            } elseif (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.png")) {
                $pic = _JLPATH_SITE . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.png";
                $piclink = _JLPATH_SITE . "/images/boss/$directory/contents/" . $content->id . $ext_name . ".png";
            } elseif (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.gif")) {
                $pic = _JLPATH_SITE . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.gif";
                $piclink = _JLPATH_SITE . "/images/boss/$directory/contents/" . $content->id . $ext_name . ".gif";
            } else {
                $pic = null;
            }
            ...
            if (!is_null($pic)) {
                switch ($field_values['image_display']) {
                    case 'gallery':
                        $return .= "<li><img src='" . $piclink . "' alt='" . htmlspecialchars(stripslashes($content->name), ENT_QUOTES) . "' /></li>";
                        break;
                    case 'popup':
                        $return .= "<a href=\"javascript:popup('" . $piclink . "');\"><img src='" . $pic . "' alt='" . htmlspecialchars(stripslashes($content->name), ENT_QUOTES) . "' /></a>";
                        break;
                    case 'fancybox':
                        $return .= "<a href='" . $piclink . "'  class='fancybox' rel='fancyboxImg'><img src='" . $pic . "' alt='" . htmlspecialchars(stripslashes($content->name), ENT_QUOTES) . "' /></a>";
                        break;
                    case 'default':
                    default:
                        $return .= "<a href='" . $piclink . "' target='_blank'><img src='" . $pic . "' alt='" . htmlspecialchars(stripslashes($content->name), ENT_QUOTES) . "' /></a>";
                        break;
                }
                $image_found = 1;
            }
    ...
    function onFormSave($directory, $contentid, $field, $isUpdateMode)
    {
        ...
        for ($i = 1; $i < $nbImages + 1; $i++) {
            ...
            if ($cb_image == "delete") {
                ...
                if (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . "_t.jpg")) {
                    unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . "_t.jpg");
                } elseif (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . "_t.png")) {
                    unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . "_t.png");
                } elseif (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . "_t.gif")) {
                    unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . "_t.gif");
                }

                if (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . ".jpg")) {
                    unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . ".jpg");
                } elseif (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . ".png")) {
                    unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . ".png");
                } elseif (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . ".gif")) {
                    unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $contentid . $ext_name . ".gif");
                }
            }
            ...
            if (isset($_FILES["content_picture$i"])) {
                if ($_FILES["content_picture$i"]['size'] > $conf['max_image_size']->fieldvalue) {
                    if ($isAdmin) {
                        $url = _JLPATH_SITE . "/administrator/index2.php?option=com_boss&act=contents&task=edit&&directory=$directory&tid[]=$contentid";
                    } else {
                        $url = _JLPATH_SITE . "/index.php?option=com_boss&amp;act=contents&amp;catid=&amp;directory=$directory";
                    }
            ...
            if (isset($_FILES["content_picture$i"]) and !$_FILES["content_picture$i"]['error']) {
                ...
                createImageAndThumb(
                    ...
                    _JLPATH_ROOT . "/images/boss/$directory/contents/",
    ...
    function onDelete($directory, $content)
    {
        ...
        while ($isfile) {
            ...
            if (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.jpg")) {
                unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.jpg");
            }
            if (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.png")) {
                unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.png");
            }
            if (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.gif")) {
                unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . "_t.gif");
            }

            if (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . ".jpg")) {
                unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . ".jpg");
            }else{
                $isfile = false;
            }
            if (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . ".png")) {
                unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . ".png");
            }else{
                $isfile = false;
            }
            if (is_readable(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . ".gif")) {
                unlink(_JLPATH_ROOT . "/images/boss/$directory/contents/" . $content->id . $ext_name . ".gif");
            }else{
                $isfile = false;
            }
    ...
    function addInHead($field, $field_values)
    {
        ...
        switch ($image_display) {
            ...
            case 'popup':
                ...
                break;
            case 'fancybox':
                $params['js']['img1'] = _JLPATH_SITE . '/includes/js/jquery/plugins/fancybox/jquery.fancybox.js';
                $params['js']['img2'] = _JLPATH_SITE . '/includes/js/jquery/plugins/jquery.easing.js';
                $params['css']['img1'] = _JLPATH_SITE . '/includes/js/jquery/plugins/fancybox/jquery.fancybox.css';
